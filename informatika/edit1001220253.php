...
$query_interest = mysqli_query($connect, "SELECT * FROM interests WHERE nim = '1001220253'");
$result_interest = mysqli_fetch_assoc($query_interest);

$query_about = mysqli_query($connect, "SELECT * FROM about WHERE nim = '1001220253'");
$result_about = mysqli_fetch_assoc($query_about);

$query_skill = mysqli_query($connect, "SELECT * FROM skills WHERE nim = '1001220253'");
$results_skill = [];
while($result_skill = mysqli_fetch_assoc($query_skill)){
    $results_skill[] = $result_skill;
};

$query_award = mysqli_query($connect, "SELECT * FROM awards WHERE nim = '1001220253'");
$results_award = [];
...
if (isset($_POST['submit'])) {
    ...
    WHERE about.nim = 1001220253  AND interests.nim = about.nim  AND awards.nim = about.nim AND skills.nim = about.nim AND users.nim = about.nim
";
...
$sql = "SELECT * FROM users WHERE nim=1001220253";
$query = mysqli_query($connect, $sql);
...
$sql = "SELECT * FROM about WHERE nim=1001220253";
$query = mysqli_query($connect, $sql);
$row = mysqli_fetch_assoc($query);
...
//awards
$sql = "SELECT * FROM awards WHERE nim=1001220253";
$query = mysqli_query($connect, $sql);
$row = mysqli_fetch_assoc($query);


//interest
$sql = "SELECT * FROM interests WHERE nim=1001220253";
$query = mysqli_query($connect, $sql);
$row = mysqli_fetch_assoc($query);
...
//skills
$sql = "SELECT * FROM skills WHERE nim=1001220253";
$query = mysqli_query($connect, $sql);
$row = mysqli_fetch_assoc($query);
...
<head>
    ...
    html,
    body {
      background-image: url(https://i.ibb.co/3Tb8gmB/rachel-cook-m-Ocdke2-ZQo-E-unsplash.jpg);
...
<body>
    ...
    <form method="post" action='edit1001220253.php' enctype="multipart/form-data">
