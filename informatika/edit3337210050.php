...
if (isset($_POST['submit'])) {
    ...
    WHERE about.nim = '3337210050' AND interests.nim = about.nim  AND awards.nim = about.nim AND skills.nim = about.nim AND users.nim = about.nim
";
...
$sql = "SELECT * FROM users WHERE nim='3337210050'";
$query = mysqli_query($conn, $sql);
...
// update data user (about)
$sql = "SELECT * FROM about WHERE nim='3337210050'";
$query = mysqli_query($conn, $sql);
$row = mysqli_fetch_assoc($query);
...
//awards
$sql = "SELECT * FROM awards WHERE nim='3337210050'";
$query = mysqli_query($conn, $sql);
$row = mysqli_fetch_assoc($query);
...
//interest
$sql = "SELECT * FROM interests WHERE nim='3337210050'";
$query = mysqli_query($conn, $sql);
$row = mysqli_fetch_assoc($query);
...
//skills
$sql = "SELECT * FROM skills WHERE nim='3337210050'";
$query = mysqli_query($conn, $sql);
$row = mysqli_fetch_assoc($query);
...
<body style="background-color: #cfe2ff;">
    ...
    <form method="post" action='edit3337210050.php' enctype="multipart/form-data">
    ...
    <button style="float:right;margin:2px;" type="submit" name="submit" class="btn btn-success"><i class="fas fa-edit"><i>Update</button>
    <a style="float:right;margin:2px;" class="btn btn-primary" href="../index.php">Home</a>
</form>
<br><br>
</body>
</html>
