...
<html lang="en">
  ...
  <body style="background-color: #c7a84a;">
    <div class="col-12 navbar" style="background-color: #977d2d ;">
      <nav class="container-fluid col-12">
        <h2 style="padding: 2%; color: whitesmoke; padding-left: 40%;" class="text-center"><center>Edit Data User</center></h2>
      </nav>
    </div>
    ...
    <div class="card" >
      ...
      <div class="card-body">
        <form method="post" action="edit3337210041.php" enctype="multipart/form-data" style="padding: 0.5%;">
          <tr>
          ...
          <div><a class="btn btn-right" href="../index.php" style="color: #977d2d"><b>Update</b></a></div>
          <div><a class="btn btn-light" href="../index.php" style="color: #977d2d"><b>Back to Home</b></a></div>
        </form>
      </div>
    </div>
  </div>
